...
public class SeleniumTest
{
    ...
    public void mainTest()
    {
        ...
        addRandomItemToCartFromSearch("wino aris solaris", 1); //4 4 6
    ...
    {
        driver.findElement(By.id("payment-option-2-container")).findElement(By.className("custom-radio")).click();
    }
